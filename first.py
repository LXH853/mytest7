...
with col1:
    ...
    # 基本信息
    name = st.text_input("姓名", "陆祥和", key="name")
...
""", key="bio")
    ...
    if uploaded_file is not None:
        ...
        if os.path.exists("default.png"):
            ...
            placeholder_url = "https://pic4.zhimg.com/v2-0dc0117b953e20a51aba46523dd9b23b_b.jpg"
...
with col2:
    ...
    if uploaded_file is not None:
        ...
        if os.path.exists("default.png"):
            ...
            st.image("https://pic4.zhimg.com/v2-0dc0117b953e20a51aba46523dd9b23b_b.jpg", width=120, use_container_width=False)
