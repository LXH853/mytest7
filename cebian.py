    ...
    with col1:
        ...
        if uploaded_file is not None:
            ...
            if os.path.exists("default.png"):
                ...
                placeholder_url = "https://tse1.mm.bing.net/th/id/OIP.2fmj_TgWLwpAlqk4ttH3vQHaHa?rs=1&pid=ImgDetMain&o=7&rm=3"
    ...
    with col2:
        ...
        if uploaded_file is not None:
            ...
            if os.path.exists("default.png"):
                ...
                st.image("https://tse1.mm.bing.net/th/id/OIP.2fmj_TgWLwpAlqk4ttH3vQHaHa?rs=1&pid=ImgDetMain&o=7&rm=3", width=120, use_container_width=False)
        # 个人信息（两栏布局）
